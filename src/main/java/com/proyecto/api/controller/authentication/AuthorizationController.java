...
public class AuthorizationController {
    ...
    public ResponseEntity<TokenDto> generationJwt(@RequestBody LoginDto loginDto){
        ...
        if (userFound != null){
            ...
            System.out.println("Validacion directa " + passwordEncryptService.isPasswordMatch(loginDto.getPassword(), "$2a$10$FNyzRWxXGmYCmh8fDpyXRujs.8k1xP1281/p3wQCYm58mX5duH57O"));
